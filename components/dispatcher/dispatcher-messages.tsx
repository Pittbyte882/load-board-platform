...
export function DispatcherMessages() {
  ...
  const [filterType, setFilterType] = useState<"all" | "unread" | "brokers" | "carriers">("all")
  ...
  const handleSendMessage = () => {
    ...
    addMessage({
      ...
      senderRole: user.role as "dispatcher",
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Communicate with brokers and carriers</p>
        </div>
          ...
          <CardHeader className="pb-3">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-1">
                {["all", "unread", "brokers", "carriers"].map((filter) => (
                  <Button
                    key={filter}
            ...
            <>
              ...
              <CardContent className="flex flex-col h-[400px]">
                    ...
                    >
                      <div
                        className={`max-w-[70%] p-3 rounded-lg ${
                          message.senderId === user?.id ? "bg-green-600 text-white" : "bg-gray-100 text-gray-900"
                        }`}
                      >
                        <p className="text-sm">{message.content}</p>
                        <p
                          className={`text-xs mt-1 ${message.senderId === user?.id ? "text-green-100" : "text-gray-500"}`}
                        >
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <Button onClick={handleSendMessage} className="self-end bg-green-600 hover:bg-green-700">
